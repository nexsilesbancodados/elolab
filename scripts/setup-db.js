...
/**
 * Script para inicializar o banco de dados com as migrações necessárias
 * Use: node scripts/setup-db.js
 */
...
-- Expandir forma_pagamento CHECK
...
console.log('=' .repeat(60));
console.log('\n✅ Copie o SQL acima e execute em: https://supabase.com/dashboard/project/[projeto]/sql');
