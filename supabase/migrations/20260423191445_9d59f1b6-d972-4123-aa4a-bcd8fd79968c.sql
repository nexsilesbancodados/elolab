-- Update notification_templates check constraint
ALTER TABLE public.notification_templates DROP CONSTRAINT IF EXISTS notification_templates_categoria_check;
ALTER TABLE public.notification_templates ADD CONSTRAINT notification_templates_categoria_check
  CHECK (categoria IN ('lembrete_consulta', 'confirmacao', 'confirmacao_consulta', 'resultado_exame', 'aniversario', 'financeiro', 'recibo_pagamento', 'estoque', 'geral'));
